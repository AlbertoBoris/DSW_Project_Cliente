...
public class PedidoController {
	...
	@ResponseBody
	public Pedido buscar(@RequestParam("codigo") int cod) {
		Pedido bean = null;
		try {
			RestTemplate rt = new RestTemplate();

			ResponseEntity<Pedido> response = rt.getForEntity(REST_PEDIDO + "buscar/" + cod, Pedido.class);
	...
	public String eliminar(@RequestParam("codigo") int cod, RedirectAttributes redirect) {
		try {
			RestTemplate rt = new RestTemplate();
			rt.delete(REST_PEDIDO + "eliminar/" + cod);
